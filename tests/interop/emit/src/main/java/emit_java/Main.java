...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] r_all_types__scalars = TestAllTypesScalars.run(vecDir, outDir); passed += r_all_types__scalars[0]; failed += r_all_types__scalars[1];
        int[] r_all_types__opt = TestAllTypesOpt.run(vecDir, outDir); passed += r_all_types__opt[0]; failed += r_all_types__opt[1];
        int[] r_all_types__pairs = TestAllTypesPairs.run(vecDir, outDir); passed += r_all_types__pairs[0]; failed += r_all_types__pairs[1];
        int[] r_all_types__many = TestAllTypesMany.run(vecDir, outDir); passed += r_all_types__many[0]; failed += r_all_types__many[1];
        int[] r_all_types__arrays = TestAllTypesArrays.run(vecDir, outDir); passed += r_all_types__arrays[0]; failed += r_all_types__arrays[1];
        int[] r_all_types__nests = TestAllTypesNests.run(vecDir, outDir); passed += r_all_types__nests[0]; failed += r_all_types__nests[1];
        int[] r_all_types__mixed = TestAllTypesMixed.run(vecDir, outDir); passed += r_all_types__mixed[0]; failed += r_all_types__mixed[1];
        int[] r_all_types__recursive = TestAllTypesRecursive.run(vecDir, outDir); passed += r_all_types__recursive[0]; failed += r_all_types__recursive[1];
        int[] r_all_types__wide = TestAllTypesWide.run(vecDir, outDir); passed += r_all_types__wide[0]; failed += r_all_types__wide[1];
        int[] r_all_types__edge = TestAllTypesEdge.run(vecDir, outDir); passed += r_all_types__edge[0]; failed += r_all_types__edge[1];
        int[] r_all_types__extra = TestAllTypesExtra.run(vecDir, outDir); passed += r_all_types__extra[0]; failed += r_all_types__extra[1];
        ...
        int[] r_all_types__enums = TestAllTypesEnums.run(vecDir, outDir); passed += r_all_types__enums[0]; failed += r_all_types__enums[1];
        int[] r_all_types__unions = TestAllTypesUnions.run(vecDir, outDir); passed += r_all_types__unions[0]; failed += r_all_types__unions[1];
